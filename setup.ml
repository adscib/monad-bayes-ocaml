...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2d3d416a64977d82561e5b60a7266ebf) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/adscib/monad-bayes-ocaml";
          bugreports = None;
          ...
          description =
            Some
              [
                 OASISText.Para
                   "An experimental port of the MonadBayes Haskell library."
              ];
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("owl", None);
                           FindlibPackage ("higher", None)
                        ];
                   ...
                   {
                      lib_modules = ["Numeric"; "Distribution"; "Monad"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "monad-bayes"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
     ...
     oasis_digest = Some "m\139\022\135_\191\216d^]\240\162\0244I\245";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
